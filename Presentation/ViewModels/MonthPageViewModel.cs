...
namespace DutyPlanner.Presentation.ViewModels
{
    public class MonthPageViewModel : ViewModel
    {
        ...
        public MonthPageViewModel(int year, int month, string folderPath, IDialogService dialogService, ILocalizationService localization, IDayRepository dayRepository, ISettingsService settings)
        {
            Year = year;
            Month = month;
